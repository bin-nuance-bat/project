...
class SnackChat extends Component {
	...
	update = async () => {
		...
		this.ctx.drawImage(
			this.filter,
			body.shoulders.right.x - body.shoulders.span * 1.5 + (body.shoulders.span * body.shoulders.angle),
		...
		// Clip face
		this.ctx.save();
		this.ctx.translate(body.ears.right.x + body.ears.width / 2, body.ears.right.y + body.ears.height * body.ears.angle);
