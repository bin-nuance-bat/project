...
export default class Webcam extends Component {
  ...
  getCanvas() {
    ...
    if (!this.ctx) {
      ...
      canvas.width = this.props.screenshotWidth;
      canvas.height = this.props.screenshotWidth;
    ...
    const scaleFactor =
      canvas.width / Math.min(this.video.videoWidth, this.video.videoHeight);

    ctx.drawImage(
      this.video,
      -(this.video.videoWidth * scaleFactor - canvas.width) / 2,
      -(this.video.videoHeight * scaleFactor - canvas.height) / 2,
      this.video.videoWidth * scaleFactor,
      this.video.videoHeight * scaleFactor
    );
